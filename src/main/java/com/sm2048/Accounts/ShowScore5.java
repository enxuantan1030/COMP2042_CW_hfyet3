...
public class ShowScore5 {

    private static ShowScore5 singleInstance = null;
     ...
     */
    public static ShowScore5 getInstance() {
        if (singleInstance == null)
            singleInstance = new ShowScore5();
        return singleInstance;
    }

    @FXML
    private TextArea highScoreList5;
    ...
    public void initialize() throws IOException {
        highScoreList5.setText(sortLines5());
    }
     ...
     * @throws IOException if fail to load file
     */
    private String sortLines5() throws IOException {
        String allContent = new String(Files.readAllBytes(Paths.get(Main.data_path5x5)));
